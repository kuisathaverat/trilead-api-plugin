...
/*
Copied from Core, so that it's still available outside of core to any dependent items once we delete this from core.
Probably safe to just delete in reality, it's been deprecated since 2013.
 */
/**
